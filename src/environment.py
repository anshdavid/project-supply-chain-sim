...
#     @staticmethod
#     def get_event_by_id(task_list: list[TaskLog], event_id: str, task_id: str | None = None) -> EventLog | None:
#         if task_id:
...
#         else:
#             return next(
#                 (event for task in task_list for event in task.task_events if event.event_id == event_id),
#                 None,
#             )
